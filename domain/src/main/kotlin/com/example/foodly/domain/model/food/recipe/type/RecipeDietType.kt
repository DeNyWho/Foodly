...
sealed class RecipeDietType(val value: String, val description: String) {
    data object GlutenFree: RecipeDietType(
        value = "Gluten Free",
    ...
    data object Ketogenic: RecipeDietType(
        value = "Ketogenic",
    ...
    data object Whole30: RecipeDietType(
        value = "Whole30",
